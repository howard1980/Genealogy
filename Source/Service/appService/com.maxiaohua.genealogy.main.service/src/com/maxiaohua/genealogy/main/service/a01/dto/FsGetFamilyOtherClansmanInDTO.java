...
public class FsGetFamilyOtherClansmanInDTO implements java.io.Serializable, Comparable<FsGetFamilyOtherClansmanInDTO> {
	/**
	* Serial ID
	*/
	...
	*/
    ...
    public int compareTo(
    		FsGetFamilyOtherClansmanInDTO compareToDTO) {
