...
public class FsLoginInDTO implements java.io.Serializable, Comparable<FsLoginInDTO> {
	/**
	* Serial ID
	*/
	...
	*/
	...
	/**
	* <code>familyCode</code>设定
	* @param familyCode　<code>familyCode</code>设定值
	*/
