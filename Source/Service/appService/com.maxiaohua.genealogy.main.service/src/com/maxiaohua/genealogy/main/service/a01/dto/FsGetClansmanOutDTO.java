 ...
 *
 */
@com.maxiaohua.genealogy.fw.core.type.AliasKanJi("获得用户族人通讯列表")
public class FsGetClansmanOutDTO implements java.io.Serializable, Comparable<FsGetClansmanOutDTO> {
	/**
	* Serial ID
	*/
	...
	*/
    ...
    public int compareTo(
    		FsGetClansmanOutDTO compareToDTO) {
