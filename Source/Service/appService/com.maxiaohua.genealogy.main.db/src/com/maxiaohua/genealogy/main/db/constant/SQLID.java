...
/**
 * Customize銇甋QL ID銇懡鍚嶃倰绠＄悊銇欍倠瀹氭暟銈儵銈广仹銇欍�<br>
 * SQL ID銇懡鍚嶃伅涓嬭銇儷銉笺儷銇緭銇ｃ仸銇忋仩銇曘亜銆�br>
 * 鈶燬QL ID銇鎴愶細 <銉夈儭銈ゃ兂ID>.<銉嗐兗銉栥儷ID>_<銈偍銉狪D><br>
 * 鈶�銉夈儭銈ゃ兂ID> 鈫�鑻卞瓧灏忔枃瀛�br>
 *銆��<銉嗐兗銉栥儷ID> 鈫�鑻卞瓧澶ф枃瀛�br>
 *銆��<銈偍銉狪D>銆�    鈫�鑻卞瓧澶ф枃瀛�br>
 *
 * @author Y.MA
 */
public interface SQLID {
	
	public static final String COURSE_RECOMMEND_DELETE_BY = "custom.COURSE_RECOMMEND_DELETE_BY";
	
	public static final String USER_JURISDICTION_DELETE_BYUID = "custom.USER_JURISDICTION_DELETE_BYUID";
	
	public static final String TEACHER_COURSETY_DELETE_BYTID = "custom.TEACHER_COURSETY_DELETE_BYTID";
	
	public static final String LOGIN_USRE_EQUAL_SEARCH = "custom.LOGIN_USRE_EQUAL_SEARCH";

	public static final String VCOURSERECOMMEND_PAGE_SQL_SEARCH = "custom.VCOURSERECOMMEND_PAGE_SQL_SEARCH";

	public static final String VCOURSE_PAGE_SQL_SEARCH = "custom.VCOURSE_PAGE_SQL_SEARCH";

	public static final String COURSE_SECTION_FATHER_SEARCH = "custom.COURSE_SECTION_FATHER_SEARCH";

	public static final String HOMEWORKHISTORY_DELETE_HWID = "custom.HOMEWORKHISTORY_DELETE_HWID";
	
	public static final String NEXT_LESSON_FIND = "custom.NEXT_LESSON_FIND";
	 ...
	 * 浜堢磩鏃ャ仺褰撴棩銇瘮杈冪祼鏋溿倰鍙栧緱銇欍倠銆�
	 */
	public final String DUAL_FIND_FOR_DATECOMPARE = "custom.DUAL_FIND_FOR_DATECOMPARE";

	/**
	 * 鍏ㄦ偅鑰呫儠銉┿偘="1"銇牬鍚堛�澶栨潵鎮ｈ�鎯呭牨銇湁鍔广仾銉偝銉笺儔妞滅储鐢⊿QL銈兗
	 * ykDate>=current date銇牬鍚堛�VGDRPTF銈掓绱€仚銈嬨�
	 */
	public static final String GREATER_THAN_CURRENTDATE_ALL_PATIENT = "custom.VGDRPTF_SEARCH_FOR_GREATERTHANCURRENTDATE_ALLPATIENT";

	/**
	 * 鍏ㄦ偅鑰呫儠銉┿偘="1"銇牬鍚堛�澶栨潵鎮ｈ�鎯呭牨銇湁鍔广仾銉偝銉笺儔妞滅储鐢⊿QL銈兗
	 * ykDate<current date銇牬鍚堛�VGDRPTF銇╒GDRPTR涓℃柟銈掓绱€仚銈嬨�
	 */
	public static final String LESS_THAN_CURRENTDATE_ALL_PATIENT = "custom.VGDRPTF_SEARCH_FOR_LESSTHANCURRENTDATE_ALLPATIENT";

	/**
	 * 鍖诲斧ID銇屻仾銇勫牬鍚堛�澶栨潵鎮ｈ�鎯呭牨銇湁鍔广仾銉偝銉笺儔妞滅储鐢⊿QL銈兗
	 * ykDate<current date銇牬鍚堛�VGDRPTF銇╒GDRPTR涓℃柟銈掓绱€仚銈嬨�
	 */
	public static final String LESS_THAN_CURRENTDATE = "custom.VGDRPTF_SEARCH_FOR_LESSTHANCURRENTDATE";

	/**
	 * 鍖诲斧ID銇屻亗銈嬪牬鍚堛�澶栨潵鎮ｈ�鎯呭牨銇湁鍔广仾銉偝銉笺儔妞滅储鐢⊿QL銈兗
	 * ykDate<current date銇牬鍚堛�VGDRPTF銇╒GDRPTR涓℃柟銈掓绱€仚銈嬨�
	 */
	public static final String LESS_THAN_CURRENTDATE_DRID = "custom.VGDRPTF_SEARCH_FOR_LESSTHANCURRENTDATE_DRID";
