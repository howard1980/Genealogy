...
public class HaveStringValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            permissionChars = ((com.maxiaohua.genealogy.fw.core.validator.type.HaveString) annotation).value();
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.HaveString) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.HaveString.DEFAULT_ERROR_CODE;
        }
    }
