...
public class AfterTimeValidator extends AnnotationValidator implements MessageCode {
    ...
    protected void prepare() {
        if (annotation != null) {
            timeStr = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterTime) annotation).compareTo();
            ifEqual = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterTime) annotation).ifEqual();
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterTime) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.AfterTime.DEFAULT_ERROR_CODE;
        }
    }
