...
public class TimeValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            format = ((com.maxiaohua.genealogy.fw.core.util.validator.type.Time) annotation).format();
            errorCode = ((com.maxiaohua.genealogy.fw.core.util.validator.type.Time) annotation).errorCode();
        } else { 
