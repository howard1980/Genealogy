...
import com.maxiaohua.genealogy.fw.core.util.validator.impl.ZipcodeValidator;


@RuleDescriptor("Zipcode")
@Constraint(validator = ZipcodeValidator.class)
@Target({ java.lang.annotation.ElementType.ANNOTATION_TYPE, java.lang.annotation.ElementType.FIELD })
@Retention(RetentionPolicy.RUNTIME)
public @interface Zipcode {
    
    public static final String DEFAULT_ERROR_CODE = MessageCode.M10260CM;
