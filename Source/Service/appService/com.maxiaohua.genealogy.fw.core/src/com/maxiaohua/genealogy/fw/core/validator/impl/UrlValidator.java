...
public class UrlValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            allowallschemes = ((com.maxiaohua.genealogy.fw.core.validator.type.Url) annotation).allowallschemes();
            allow2slashes = ((com.maxiaohua.genealogy.fw.core.validator.type.Url) annotation).allow2slashes();
            nofragments = ((com.maxiaohua.genealogy.fw.core.validator.type.Url) annotation).nofragments();
            schemes = ((com.maxiaohua.genealogy.fw.core.validator.type.Url) annotation).schemes();
            if (StringUtil.isEmpty(schemes)) {
                schemes = null;
            }
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.Url) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.Url.DEFAULT_ERROR_CODE;
        }
    }
