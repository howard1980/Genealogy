...
import com.maxiaohua.genealogy.fw.core.util.validator.impl.ZenkakuValidator;


@RuleDescriptor("Zenkaku")
@Constraint(validator = ZenkakuValidator.class)
...
public @interface Zenkaku {
    ...
    public static final String DEFAULT_ERROR_CODE = MessageCode.M10470CM;
