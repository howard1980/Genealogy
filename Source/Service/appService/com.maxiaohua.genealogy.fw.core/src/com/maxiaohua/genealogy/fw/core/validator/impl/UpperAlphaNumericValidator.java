...
public class UpperAlphaNumericValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.UpperAlphaNumeric) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.UpperAlphaNumeric.DEFAULT_ERROR_CODE;
        }
    }
