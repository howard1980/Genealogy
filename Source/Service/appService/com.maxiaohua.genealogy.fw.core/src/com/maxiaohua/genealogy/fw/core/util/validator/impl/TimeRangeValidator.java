...
public class TimeRangeValidator extends AnnotationValidator implements MessageCode {
    ...
    protected void prepare() {
        if (annotation != null) {
            lagerEqual = ((com.maxiaohua.genealogy.fw.core.util.validator.type.TimeRange) annotation).lagerEqual();
            lagerThan = ((com.maxiaohua.genealogy.fw.core.util.validator.type.TimeRange) annotation).lagerThan();
            lessEqual = ((com.maxiaohua.genealogy.fw.core.util.validator.type.TimeRange) annotation).lessEqual();
            lessThan = ((com.maxiaohua.genealogy.fw.core.util.validator.type.TimeRange) annotation).lessThan();
            errorCode = ((com.maxiaohua.genealogy.fw.core.util.validator.type.TimeRange) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.util.validator.type.TimeRange.DEFAULT_ERROR_CODE;
        }
    }
