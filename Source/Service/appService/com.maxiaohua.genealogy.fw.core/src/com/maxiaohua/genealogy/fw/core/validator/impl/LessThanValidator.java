...
public class LessThanValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            otherValues = new String[] { ((com.maxiaohua.genealogy.fw.core.validator.type.LessThan) annotation).compareTo() };
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.LessThan) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.LessThan.DEFAULT_ERROR_CODE;
        }
    }
