...
public class AfterDateSqlValidator extends AnnotationValidator implements MessageCode {
    ...
    protected void prepare() {
        if (annotation != null) {
            dateStr = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterDateSql) annotation).compareTo();
            ifEqual = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterDateSql) annotation).ifEqual();
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterDateSql) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.AfterDateSql.DEFAULT_ERROR_CODE;
        }
    }
