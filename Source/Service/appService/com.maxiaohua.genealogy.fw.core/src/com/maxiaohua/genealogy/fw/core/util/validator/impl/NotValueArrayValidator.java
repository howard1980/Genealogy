...
public class NotValueArrayValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            otherValues = ((com.maxiaohua.genealogy.fw.core.util.validator.type.NotValueArray) annotation).values();
            errorCode = ((com.maxiaohua.genealogy.fw.core.util.validator.type.NotValueArray) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.util.validator.type.NotValueArray.DEFAULT_ERROR_CODE;
        }
    }
