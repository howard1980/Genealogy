...
public class BeforeTimeValidator extends AnnotationValidator implements MessageCode {
    ...
    protected void prepare() {
        if (annotation != null) {
            timeStr = ((com.maxiaohua.genealogy.fw.core.validator.type.BeforeTime) annotation).compareTo();
            ifEqual = ((com.maxiaohua.genealogy.fw.core.validator.type.BeforeTime) annotation).ifEqual();
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.BeforeTime) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.BeforeTime.DEFAULT_ERROR_CODE;
        }
    }
