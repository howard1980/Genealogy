...
import com.maxiaohua.genealogy.fw.core.validator.type.ValueArray;
...
public class ValueArrayValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            ...
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.ValueArray.DEFAULT_ERROR_CODE;
        }
    }
