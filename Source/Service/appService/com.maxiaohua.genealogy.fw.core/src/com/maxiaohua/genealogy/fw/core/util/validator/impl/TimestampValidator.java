...
public class TimestampValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            format = ((com.maxiaohua.genealogy.fw.core.util.validator.type.Timestamp) annotation).format();
            errorCode = ((com.maxiaohua.genealogy.fw.core.util.validator.type.Timestamp) annotation).errorCode();
        } else { 
