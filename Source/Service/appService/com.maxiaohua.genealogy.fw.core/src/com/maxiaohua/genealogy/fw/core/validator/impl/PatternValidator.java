...
public class PatternValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            mask = ((com.maxiaohua.genealogy.fw.core.validator.type.Pattern) annotation).value();
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.Pattern) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.Pattern.DEFAULT_ERROR_CODE;
        }
    }
