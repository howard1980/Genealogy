...
public class BeforeDateSqlValidator extends AnnotationValidator implements MessageCode {
    ...
    protected void prepare() {
        if (annotation != null) {
            dateStr = ((com.maxiaohua.genealogy.fw.core.util.validator.type.BeforeDateSql) annotation).compareTo();
            ifEqual = ((com.maxiaohua.genealogy.fw.core.util.validator.type.BeforeDateSql) annotation).ifEqual();
            errorCode = ((com.maxiaohua.genealogy.fw.core.util.validator.type.BeforeDateSql) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.util.validator.type.BeforeDateSql.DEFAULT_ERROR_CODE;
        }
    }
