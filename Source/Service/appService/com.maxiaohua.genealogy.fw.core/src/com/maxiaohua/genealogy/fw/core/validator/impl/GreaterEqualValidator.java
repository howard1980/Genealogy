...
public class GreaterEqualValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            otherValues = new String[] { ((com.maxiaohua.genealogy.fw.core.validator.type.GreaterEqual) annotation).compareTo() };
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.GreaterEqual) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.GreaterEqual.DEFAULT_ERROR_CODE;
        }
    }
