...
public class AfterValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        try {
            if (otherValues != null) { 
                ifEqual = false;
                errorCode = com.maxiaohua.genealogy.fw.core.validator.type.After.DEFAULT_ERROR_CODE;
                dateStr = otherValues[0].toString();
            } else {
                ifEqual = ((com.maxiaohua.genealogy.fw.core.validator.type.Before) annotation).ifEqual();
                errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.After) annotation).errorCode();
                dateStr = ((com.maxiaohua.genealogy.fw.core.validator.type.After) annotation).compareTo();
            }
