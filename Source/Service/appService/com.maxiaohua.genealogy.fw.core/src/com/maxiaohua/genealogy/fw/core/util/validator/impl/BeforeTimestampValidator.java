...
public class BeforeTimestampValidator extends AnnotationValidator implements MessageCode {
    ...
    protected void prepare() {
        if (annotation != null) {
            timestampStr = ((com.maxiaohua.genealogy.fw.core.util.validator.type.BeforeTimestamp) annotation).compareTo();
            ifEqual = ((com.maxiaohua.genealogy.fw.core.util.validator.type.BeforeTimestamp) annotation).ifEqual();
            errorCode = ((com.maxiaohua.genealogy.fw.core.util.validator.type.BeforeTimestamp) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.util.validator.type.BeforeTimestamp.DEFAULT_ERROR_CODE;
        }
    }
