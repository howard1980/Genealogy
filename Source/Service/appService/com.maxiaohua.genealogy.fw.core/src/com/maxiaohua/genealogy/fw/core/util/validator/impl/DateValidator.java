...
public class DateValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            format = ((com.maxiaohua.genealogy.fw.core.util.validator.type.Date) annotation).format();
            errorCode = ((com.maxiaohua.genealogy.fw.core.util.validator.type.Date) annotation).errorCode();
        } else { 
            format = DateUtil.FORMAT.YYYYMMDDHyphen;
            errorCode = com.maxiaohua.genealogy.fw.core.util.validator.type.Date.DEFAULT_ERROR_CODE;
        }
    }
