...
public class HankakuValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.Hankaku) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.Hankaku.DEFAULT_ERROR_CODE;
        }
    }
