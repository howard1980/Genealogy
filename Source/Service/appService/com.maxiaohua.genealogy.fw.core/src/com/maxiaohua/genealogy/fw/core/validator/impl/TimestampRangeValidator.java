...
public class TimestampRangeValidator extends AnnotationValidator implements MessageCode {
    ...
    protected void prepare() {
        if (annotation != null) {
            lagerEqual = ((com.maxiaohua.genealogy.fw.core.validator.type.TimestampRange) annotation).lagerEqual();
            lagerThan = ((com.maxiaohua.genealogy.fw.core.validator.type.TimestampRange) annotation).lagerThan();
            lessEqual = ((com.maxiaohua.genealogy.fw.core.validator.type.TimestampRange) annotation).lessEqual();
            lessThan = ((com.maxiaohua.genealogy.fw.core.validator.type.TimestampRange) annotation).lessThan();
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.TimestampRange) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.TimestampRange.DEFAULT_ERROR_CODE;
        }
    }
