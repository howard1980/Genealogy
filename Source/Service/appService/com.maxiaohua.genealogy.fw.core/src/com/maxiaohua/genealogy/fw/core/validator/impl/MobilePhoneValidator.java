...
public class MobilePhoneValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.MobilePhone) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.MobilePhone.DEFAULT_ERROR_CODE;
        }
    }
