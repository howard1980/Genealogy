...
public class BigIntegerValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            errorCode = ((com.maxiaohua.genealogy.fw.core.util.validator.type.BigInteger) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.util.validator.type.BigInteger.DEFAULT_ERROR_CODE;
        }
    }
