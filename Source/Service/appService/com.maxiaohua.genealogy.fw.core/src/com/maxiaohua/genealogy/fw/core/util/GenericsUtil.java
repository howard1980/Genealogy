...
abstract public class GenericsUtil {
    ...
    protected static Class<?> resolveTypeVariable(
        ...
        for (int i = ancestorTypeList.size() - 1; i >= 0; i--) {
            ...
            if (!(declaration instanceof Class)) {
                throw new IllegalStateException("TypeVariable(" + targetType.getName() + " is not declared at Class "
    ...
    protected static boolean isNotTypeVariable(
        ...
        throw new IllegalStateException("Type(" + type + ") is not instance of " + TypeVariable.class.getName() + ", "
                + ParameterizedType.class.getName() + ", " + GenericArrayType.class.getName() + " nor " + Class.class.getName());
    }
