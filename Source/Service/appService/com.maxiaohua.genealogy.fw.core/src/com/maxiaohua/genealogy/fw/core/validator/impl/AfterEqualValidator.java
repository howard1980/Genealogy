...
public class AfterEqualValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        try {
            if (otherValues != null) { 
                errorCode = com.maxiaohua.genealogy.fw.core.validator.type.AfterEqual.DEFAULT_ERROR_CODE;
                dateStr = otherValues[0].toString();
            } else {
                errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterEqual) annotation).errorCode();
                dateStr = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterEqual) annotation).compareTo();
            }
