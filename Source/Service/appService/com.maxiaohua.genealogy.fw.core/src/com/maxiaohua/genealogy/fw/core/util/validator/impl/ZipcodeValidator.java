...
public class ZipcodeValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            errorCode = ((com.maxiaohua.genealogy.fw.core.util.validator.type.Zipcode) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.util.validator.type.Zipcode.DEFAULT_ERROR_CODE;
        }
    }
