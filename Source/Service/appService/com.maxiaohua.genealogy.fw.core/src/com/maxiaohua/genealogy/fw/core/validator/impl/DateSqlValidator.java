...
public class DateSqlValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            format = ((com.maxiaohua.genealogy.fw.core.validator.type.DateSql) annotation).format();
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.DateSql) annotation).errorCode();
        } else { 
