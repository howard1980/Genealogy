...
public class DateRangeValidator extends AnnotationValidator implements MessageCode {
    ...
    protected void prepare() {
        if (annotation != null) {
            lagerEqual = ((com.maxiaohua.genealogy.fw.core.validator.type.DateRange) annotation).lagerEqual();
            lagerThan = ((com.maxiaohua.genealogy.fw.core.validator.type.DateRange) annotation).lagerThan();
            lessEqual = ((com.maxiaohua.genealogy.fw.core.validator.type.DateRange) annotation).lessEqual();
            lessThan = ((com.maxiaohua.genealogy.fw.core.validator.type.DateRange) annotation).lessThan();
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.DateRange) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.DateRange.DEFAULT_ERROR_CODE;
        }
    }
