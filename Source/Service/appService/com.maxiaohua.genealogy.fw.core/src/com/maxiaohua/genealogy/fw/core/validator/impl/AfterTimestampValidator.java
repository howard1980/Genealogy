...
public class AfterTimestampValidator extends AnnotationValidator implements MessageCode {
    ...
    protected void prepare() {
        if (annotation != null) {
            timestampStr = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterTimestamp) annotation).compareTo();
            ifEqual = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterTimestamp) annotation).ifEqual();
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.AfterTimestamp) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.AfterTimestamp.DEFAULT_ERROR_CODE;
        }
    }
