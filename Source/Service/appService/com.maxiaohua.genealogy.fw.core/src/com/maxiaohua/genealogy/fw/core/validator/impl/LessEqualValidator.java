...
public class LessEqualValidator extends AnnotationValidator {
    ...
    protected void prepare() {
        if (annotation != null) {
            otherValues = new String[] { ((com.maxiaohua.genealogy.fw.core.validator.type.LessEqual) annotation).compareTo() };
            errorCode = ((com.maxiaohua.genealogy.fw.core.validator.type.LessEqual) annotation).errorCode();
        } else { 
            errorCode = com.maxiaohua.genealogy.fw.core.validator.type.LessEqual.DEFAULT_ERROR_CODE;
        }
    }
