...
@interface NoticeInfoDTO : ServiceBaseModel
...
@property(nonatomic,strong)NSMutableArray *attentionFace; /**< 关注用后头像*/
@property(nonatomic,strong)NSMutableArray *noticeComments; /**< 评论详细*/
